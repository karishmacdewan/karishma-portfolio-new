...
export const Contact = () => {
  return (
    <FullPageChapter
      ...
      labelledBy="contact-chapter-title"
    >
        ...
        <div className={styles.leftColumn}>
          ...
          <ContactReveal delay={0.1}>
            <p className={styles.supportingCopy}>
              For enterprise AI transformation, strategic advisory and selected
        ...
        <div className={styles.contactActions}>
          <ContactReveal delay={0.24} className={styles.actionReveal}>
            <Link
              ...
              href={EMAIL_URL}
              aria-label={`Start a conversation by emailing ${EMAIL_ADDRESS}`}
            >
